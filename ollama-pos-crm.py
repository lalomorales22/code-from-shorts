...
<body>
    ...
    <div class="main-content">
        ...
        <div id="ai-page" class="page hidden">
            <div class="header">
                <h1>AI Assistant</h1>
                <p class="subtitle">Chat with your local AI assistant powered by Ollama</p>
            </div>
            
            <div id="ollama-status" class="ollama-status disconnected">
            ...
            <div class="chat-container">
                <div class="chat-messages" id="chat-messages">
                    <div class="message ai">
                        Hello! I'm your business AI assistant powered by Ollama. I can help you manage products, customers, orders, and more. Select a model and start chatting!
                    </div>
                </div>
                <div class="chat-input">
                    <div class="chat-controls">
                        <label for="model-select" style="margin: 0; font-size: 14px;">Model:</label>
                    ...
                    <div class="chat-text-input">
                        <input type="text" id="chat-input" placeholder="Ask me anything about your business..." onkeypress="if(event.key==='Enter') sendMessage()" disabled>
    ...
    <script>
        ...
        // Check Ollama connection and load models on page load
        ...
        async function checkOllamaConnection() {
            try {
                ...
                updateOllamaStatus('disconnected', 'Cannot connect to Ollama. Make sure Ollama is running on localhost:11434');
        ...
        function updateOllamaStatus(status, message) {
            ...
            statusEl.className = `ollama-status ${status}`;
        ...
        async function loadAvailableModels() {
            try {
                ...
                if (availableModels.length === 0) {
                    updateOllamaStatus('disconnected', 'No models found. Pull a model first: ollama pull llama2');
                }
            } catch (error) {
                console.error('Error loading models:', error);
                updateOllamaStatus('disconnected', 'Error loading models from Ollama');
            }
        }
        ...
        function updateSelectedModel() {
            ...
            if (selectedModel && ollamaConnected) {
                ...
                chatInput.placeholder = `Ask me anything about your business... (using ${selectedModel})`;
            } else {
                chatInput.disabled = true;
                sendBtn.disabled = true;
        ...
        async function refreshModels() {
            updateOllamaStatus('connected', 'Refreshing models...');
            await loadAvailableModels();
            updateOllamaStatus('connected', `Connected to Ollama - ${availableModels.length} models available`);
        }
        ...
        async function sendMessage() {
            if (!selectedModel || !ollamaConnected) {
                alert('Please select a model and ensure Ollama is connected');
                return;
            }
            ...
            messagesDiv.innerHTML += `<div class="message system">AI is thinking...</div>`;
            ...
            try {
                ...
                // Prepare the system prompt with business context
                const systemPrompt = `You are a helpful business assistant. Here's the current business data: ${JSON.stringify(context, null, 2)}. 
                
Based on this data, help the user with their business questions. You can provide insights about:
...
Be concise and practical in your responses.`;
                ...
                // Send to Ollama API using chat format
                ...
                if (messages.length > 0 && messages[messages.length - 1].classList.contains('system')) {
                ...
                messagesDiv.innerHTML += `<div class="message system">Error connecting to Ollama: ${error.message}. Make sure Ollama is running and the selected model is available.</div>`;
            }
        ...
        async function getBusinessContext() {
            try {
                ...
                return {
                    ...
                    products: products.slice(0, 10), // Recent products
